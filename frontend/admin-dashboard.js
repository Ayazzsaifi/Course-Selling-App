...
addCourseBtn.addEventListener("click", async function () {
    ...
    const response = await axios.post("/api/v1/admin/course",
...
async function fetchCourses(){
    const response = await axios.get("/api/v1/admin/course/bulk",{headers: { token: localStorage.getItem("adminToken") }})
